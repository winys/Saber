    ...
    mutations : {
        'NEW_TOOL' ( state, toolid ) {
            ...
            if( has < 0 ){
                ...
                Vue.nextTick(()=>{
                    Saber.commit("NEW_PLUGIN_PAGE",state.items[has].name);
                })
            }
        },
